...
Coin::Coin(int resolution, float radius)
{
...
void Coin::generateDisc(int resolution, float radius)
{
...
void Coin::generateDiscVerts(int resolution, float radius)
{
...
void Coin::generateDiscTexCoords()
{
